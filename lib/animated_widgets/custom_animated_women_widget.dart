...
class CustomWomenAnimatedWidget extends StatefulWidget {
  const CustomWomenAnimatedWidget({super.key});

  @override
  State<CustomWomenAnimatedWidget> createState() => _CustomWomenAnimatedWidgetState();
}

class _CustomWomenAnimatedWidgetState extends State<CustomWomenAnimatedWidget> {
                  ...
                  itemBuilder: (context, index) => Card(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Image.asset('assets/animation/image1.jpg',
                            fit: BoxFit.cover,
                            width: 70,
                            height: 70,
                          ),
                  ...
                  itemBuilder: (context, index) => Card(
                    child: Padding(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Image.asset('assets/animation/image2.jpg',
                            fit: BoxFit.cover,
                            width: 70,
                            height: 70,
                          ),
