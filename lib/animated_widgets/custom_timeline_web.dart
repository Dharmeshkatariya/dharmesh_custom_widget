...
import 'package:dharmesh_widget_component/animated_widgets/custom_timeline_card_widget.dart';
...
import 'custom_timeline_utills.dart';
...
class TimeLineDelegate extends BoxyDelegate {
  ...
  Widget cardWidget(TimeLineData data) => CustomTimeLineCard(data: data);
  @override
  layout() {
    BoxyChild? firstCard;
