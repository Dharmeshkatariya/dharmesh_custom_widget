...
class AppTheme {
  ...
  static TextTheme _buildTextTheme() {
    return TextTheme(
      ...
      bodyMedium: getNormalStyle(color: AppColors.grey),
      ...
      titleLarge: getNormalStyle(color: AppColors.grey),
      titleMedium: getNormalStyle(color: AppColors.grey),
      titleSmall: getNormalStyle(color: AppColors.grey),
    );
  }
